...
?>
    <h4 style="padding:5px; text-align:left; border-bottom:2px solid black; ">Admin Login</h4>
    <div class="mb-2">
...
<div class="label fs-6">
    <label for="forgotPassword" class="label">Forgot Password? <a href="reset.php" style="text-decoration:none;">Reset</a></label>
</div>
<label for="logIn" class="label">Admin Registration <a href="signup.php" style="text-decoration:none;">Click Here.</a></label>
</div>
</div>
